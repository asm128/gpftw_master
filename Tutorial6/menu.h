...
namespace gme 
{
	...
	enum MENU_OPTION_NEW : int32_t
		{ MENU_OPTION_NEW_Terrain			= 0
		, MENU_OPTION_NEW_Model
		, MENU_OPTION_NEW_Image
		, MENU_OPTION_NEW_COUNT
		};

	static	const ::gpk::view_const_string				g_MenuOptionsNew	[::gme::MENU_OPTION_NEW_COUNT]		=	
		{ "Terrain"
		, "Model"
		, "Image"
		};
